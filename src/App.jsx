...
import { useProjectAccounts } from './hooks/useProjectAccounts';
...
export default function App() {
  ...
  // Project Accounts State
  const [activeTab, setActiveTab] = useState('monthly'); // 'monthly' | 'projects'
  ...
  const projectsHook = useProjectAccounts(session);
        ...
        <>
          ...
          <div className="nav-container">
            <button
              ...
              onClick={() => { setActiveTab('monthly'); setActiveProjectId(null); }}
            >
              <Calendar size={16} /> Gastos Mensuales
            </button>
            <button
          ...
          {activeTab === 'monthly' ? (
            ...
            <ProjectsDashboard
              ...
              onBackToMonthly={() => setActiveTab('monthly')}
            />
          )}
        </>
      )}
